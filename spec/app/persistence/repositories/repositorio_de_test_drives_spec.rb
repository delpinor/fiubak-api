...
describe Persistence::Repositories::RepositorioDeTestDrives do
  ...
  let(:proveedor) { double('ProveedorDeClima', :obtener_clima => "lluvioso") }
  let(:test_drive) { TestDrive.new(publicacion, "2020-05-05", proveedor, 400) }
  ...
  it 'Al crear un test_drive debería tener cantidad 1' do
    ...
    test_drive = TestDrive.new(publicacion_guardada, "2020-05-05", proveedor, 400)
