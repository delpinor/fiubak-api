...
Característica: US027 - Contratacion de test-drive
  ...
  Escenario: 27.1 - Test drive exitoso en un dia sin lluvia
    ...
    Entonces obtengo un mensaje "Test-drive para el día de hoy contratado con éxito. Deberá abonar una suma de $10"
  ...
  Escenario: 27.2 - Test drive exitoso en un día con lluvia  
    ...
    Entonces obtengo un mensaje "Test-drive para el día de hoy contratado con éxito. Deberá abonar una suma de $8"
